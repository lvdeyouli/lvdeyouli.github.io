...
jQuery.fn.wowSlider = function (t) {
    ...
    function r(n, i, a) {
        if (!ae) {
            if (i || a) e(n); else {
                ...
                }(ee, n), q.trigger(z.Event("go", {index: n}))
            }
    ...
    function l() {
        q.find(".ws_effect").fadeOut(200), e(ee).fadeIn(200).find("img").css({visibility: "visible"})
    }
    ...
    function d(t) {
        var e = t.css("transform"), n = {top: 0, left: 0};
    ...
    function y() {
        function e(t) {
            ...
            }, n = p.get(t), i = {left: -n.offsetLeft + (z(n).outerWidth(!0) - z(n).outerWidth()) / 2};
            ...
            s.bind("mousemove mouseover", function (e) {
                if (!o) {
                    ...
                    for (var s = .2, r = 0; 2 > r; r++) {
                        ...
                        if (0 > c) {
                            ...
                            }) : n.animate(r ? {left: f} : {top: f}, p, Ee > 0 ? "linear" : "easeOutCubic")
                ...
                a = setTimeout(function () {
                    if (n.stop(), t.support.transform && t.support.transition) {
                        var e = d(n);
                        n.css({transition: "0ms linear", transform: "translate3d(" + e.left + "px," + e.top + "px,0)"})
                    }
                }, 100)
        ...
        if (we.length) {
            var c = we.find(">div"), f = z("a", we), p = f.find("IMG");
            if (p.length) {
                var h = z('<div class="ws_bulframe"/>').appendTo(c),
                    m = z("<div/>").css({width: p.length + 1 + "00%"}).appendTo(z("<div/>").appendTo(h));
            ...
            if (n == e) {
                ...
                if (i.addClass("ws_selthumb"), !Te) {
                    ...
                    if (t.support.transform && t.support.transition) {
                        ...
                        o.css({transition: "300ms ease", transform: "translate3d(" + r + "px," + l + "px,0)"})
    ...
    function _(t) {
        var e = j[t], n = z("img", e).attr("title"), i = z(e).data("descr");
        return n.replace(/\s+/g, "") || (n = ""), (n ? "<span>" + n + "</span>" : "") + (i ? "<br><div>" + i + "</div>" : "")
    }

    function C(e, n) {
        var i = _(e), a = _(n), o = t.captionEffect;
    ...
    function T(t, e, n, i, a) {
        function o(t) {
            ...
            z(s[t]).css({visibility: "visible"}).css({opacity: 0}).animate({opacity: n}, a, "easeOutCirc").animate({
                top: 0,
                left: 0
            }, {duration: a, easing: e.easing || i, queue: !1})
        }

        var s = t.find(">span,>div").get();
        z(s).css({position: "relative", visibility: "hidden"}), t.show();
        for (var r in e) if (/\%/.test(e[r])) {
            e[r] = parseInt(e[r]) / 100;
            var l = t.offset()[/left/.test(r) ? "left" : "top"], u = /left/.test(r) ? "width" : "height";
            e[r] *= e[r] < 0 ? l : q[u]() - t[u]() - l
        }
        z(s[0]).css({left: (e.left1 || 0) + "px", top: (e.top1 || 0) + "px"}), z(s[1]).css({
            left: (e.left2 || 0) + "px",
            top: (e.top2 || 0) + "px"
        });
        var a = e.duration || a;
    ...
    function E(t, e) {
        var n = {position: 0, top: 0, left: 0, bottom: 0, right: 0};
        ...
        t.wrap(o), o = t.parent(), "static" == t.css("position") ? (o.css({position: "relative"}), t.css({position: "relative"})) : (z.extend(a, {
            position: t.css("position"),
            zIndex: t.css("z-index")
        }), t.css({position: "absolute", top: 0, left: 0, right: "auto", bottom: "auto"})), o.css(a).show();
        var s = e.direction || "left", r = "up" == s || "down" == s ? "top" : "left", l = "up" == s || "left" == s,
            u = e.distance || ("top" == r ? t.outerHeight(!0) : t.outerWidth(!0));
        t.css(r, l ? isNaN(u) ? "-" + u : -u : u);
        var c = {};
        c[r] = (l ? "+=" : "-=") + u, o.animate({opacity: 1}, {
            duration: e.duration,
            easing: e.easing
        }), t.animate(c, {
    ...
    function k(e, n, i, a, o, s) {
        function r(e, n) {
            return e.css(t.support.transform ? {transform: "translate3d(" + n + "px,0px,0px)"} : {marginLeft: n})
        }

        var l = 15, u = 5, c = q.width();
        if (l *= c / 100, u *= c / 100, i == a) r(e, u).fadeIn(o / 3), r(z(">div,>span", e), 0).css("display", "inline-block"); else {
            var d = z(">div", e).css("display", "inline-block"), f = z(">div", n).css("display", "inline-block"),
                p = z(">span", e), h = z(">span", n), m = l + c * (s ? -1 : 1), v = u, g = u, w = l + c * (s ? 1 : -1),
                y = (s ? -1 : 1) * l, b = 0;
            ...
            P(function (t) {
                ...
                P(function (t) {
                    ...
                    var e = 2 * (1 - x) * y + x * b, n = (1 - x) * y + x * b, i = (1 - x) * b + -2 * x * y,
                        a = (1 - x) * b + x * -y;
    ...
    function O() {
        var e = je ? 4 : t.responsive, n = q.width() || t.width, i = z([G, H.find("img"), Q.find("img")]);
        if (e > 0 && document.addEventListener && q.css("fontSize", Math.max(10 * Math.min(n / t.width || 1, 1), 6)), 2 > e && (q.css("height", ""), i.each(function () {
                z(this).css({width: "100%", height: "auto", marginTop: 0, marginLeft: 0})
            })), 2 == e) {
            var a = n / t.width - 1, o = t.height * (1 + a);
            q.css("height", o), i.each(function () {
                z(this).css({width: "100%", height: "auto", marginTop: 0, marginLeft: 0})
            })
        }
        if (3 == e) {
            var s = window.innerHeight - q.offset().top - 45, r = t.width / t.height, l = r > n / s;
        ...
        if (4 == e) {
            var u = window.innerWidth, c = window.innerHeight, r = t.width / t.height, d = r > u / c;
            q.css({maxWidth: d ? "100%" : r * c, height: "", top: d ? (c - u / r) / 2 : 0}), i.each(function () {
                z(this).css({width: "100%", marginLeft: 0, marginTop: 0})
            })
        } else q.css({maxWidth: "", top: ""})
    }

    var z = jQuery, q = this, L = q.get(0);
    t = z.extend({
        effect: function () {
            this.go = function (t) {
                return e(t), t
    ...
    var N = z(".ws_images", q), V = N.find("ul").css("width", "100%").wrap("<div class='ws_list'></div>").parent();
    q.wrap("<div></div>"), z("<div>").css({
        width: "100%",
        visibility: "hidden",
        "font-size": 0,
        "line-height": 0
    }).append(N.find("li:first img:first").clone().css({width: "100%"})).prependTo(N), V.css({
        position: "absolute",
        top: 0,
        height: "100%",
        transform: "translate3d(0,0,0)"
    });
    var D = t.images && new wowsliderPreloader(this, t), j = N.find("li"), R = j.length,
        W = (V.width() / V.find("li").width(), {position: "absolute", top: 0, height: "100%", overflow: "hidden"}),
        H = z("<div>").addClass("ws_swipe_left").css(W).prependTo(V),
        Q = z("<div>").addClass("ws_swipe_right").css(W).appendTo(V), $ = navigator.userAgent;
    if (/MSIE/.test($) || /Trident/.test($) || /Safari/.test($) || /Firefox/.test($)) {
        var B = Math.pow(10, Math.ceil(Math.LOG10E * Math.log(R)));
        V.css({width: B + "00%"}), j.css({width: 100 / B + "%"}), H.css({
            width: 100 / B + "%",
            left: -100 / B + "%"
        }), Q.css({width: 100 / B + "%", left: 100 * R / B + "%"})
    } else V.css({width: R + "00%", display: "table"}), j.css({
        display: "table-cell",
        "float": "none",
        width: "auto"
    }), H.css({width: 100 / R + "%", left: -100 / R + "%"}), Q.css({width: 100 / R + "%", left: "100%"});
    var Y = t.onBeforeStep || function (t) {
        return t + 1
    };
    t.startSlide = n(isNaN(t.startSlide) ? Y(-1, R) : t.startSlide), D && D.load(t.startSlide, function () {
    }), e(t.startSlide);
    var X, U;
    ...
    j.each(function () {
        ...
        z(this).data("descr") || (e.text().replace(/\s+/g, "") ? z(this).data("descr", e.html().replace(/^\s+|\s+$/g, "")) : z(this).data("descr", "")), z(this).css({"font-size": 0}), z(this).data("type", t[0].tagName);
    ...
    var ee = t.startSlide, ne = ee, ie = 1, ae = 0, oe = !1;
    ...
    var re, le = z('<div class="ws_video_btn"><div></div></div>').appendTo(q), ue = new function () {
        ...
        function o(t, o) {
            ...
            re = !1, v(), s[0] && f[t] ? (q.removeClass(/MSIE/.test($) || /Trident/.test($) ? "ws_video_playing_ie" : "ws_video_playing"), J.show(), X && X.show(), Pe.fadeIn(300), i(t), "youtube" == n(t) && f[t].getPlayerState && 1 == f[t].getPlayerState() ? f[t].pauseVideo() : "vimeo" == n(t) && f[t].api("paused", function (e) {
                e || f[t].api("pause")
            }), o && a(1), s.css("opacity") > 0 ? s.animate({opacity: 0}, 500, o ? o : 0) : o && o()) : o && o()
        }

        function s(i, o, s) {
            var r = e(i);
            r[0] && (o || r.attr("data-autoplay-video") || t.autoPlayVideo) ? (re = n(i), q.addClass(/MSIE/.test($) || /Trident/.test($) ? "ws_video_playing_ie" : "ws_video_playing"), m(), Pe.fadeOut(300), l(), J.hide(), X && X.hide(), a(), "youtube" == re && f[i] && f[i].playVideo ? f[i].playVideo() : "vimeo" == re && f[i] && f[i].api("play"), r.css("opacity") < 1 ? r.css("zIndex", 1).animate({opacity: 1}, 500, s ? s : 0) : s && s()) : s && s()
        }
    ...
    if (de && (de = s(de))) {
        ...
        var ge, we = q.find(".ws_bullets"), ye = q.find(".ws_thumbs"), be = t.autoPlay, xe = !1,
        ...
        if (de = de.replace(/^\s+|\s+$/g, ""), ce = de ? z("<div>") : 0, z(ce).css({
            ...
            }), Me.attr({scrolling: "no", framespacing: 0, border: 0, frameBorder: "no"}), ce.append(Me)
        }
        if (z(ce).css({
                zIndex: 11,
                right: "5px",
                ...
                outline: "none"
            }).attr({href: "http://" + de.toLowerCase()}).html(de).bind("contextmenu", function () {
                return !1
        ...
        var Ie = function () {
            ...
            none: function (t, e, n, i, a) {
                ...
                n.stop(1, 1).fadeOut(t.captionDuration / 3, function () {
                    n.html(o), Oe.array([{left1: "100%", top2: "100%"}, {left1: "80%", left2: "-50%"}, {
                        top1: "-100%",
                        top2: "100%",
                        distance: .7,
                        easing: "easeOutBack"
        ...
        var ze = q.find("audio").get(0), qe = t.autoPlay;
        if (ze) {
    ...
    easeInOutExpo: function (t, e, n, i, a) {
        ...
        var o = Math.PI / 2, s = 1.70158, r = 0, l = i;
        if (0 == e) return n;
        if (1 == (e /= a)) return n + i;
    ...
    o ? (window.requestAnimationFrame = o, window.cancelAnimationFrame = s, t.fx.timer = function (i) {
        ...
        var e = (new Date).getTime(), n = Math.max(0, 16 - (e - i)), a = window.setTimeout(function () {
            t(e + n)
        }, n);
        return i = e + n, a
...
function ws_seven(t, e, i) {
    ...
    function n(t, e, i, a) {
        var n = e >= a ? a / e : 1, o = t >= i ? i / t : 1;
        return {l: o, t: n, m: Math.min(o, n)}
    }

    function o(t, e, i, o, r) {
        var s = M.width(), h = M.height(), c = l * s / f, w = l * h / g, u = p * (o ? 4 : 5) / (f * g),
            m = o ? "easeInExpo" : "easeOutQuart", v = T.h + T.t - h / g, x = T.w + T.l - s / f,
            b = M.offset().top + M.height(), y = M.offset().left + M.width();
        return b > v && (v = b), y > x && (x = y), d(t).each(function (t) {
            var e = t % f, r = Math.floor(t / f), b = .2 * p * (45 * a(e, f) + 4 * r) / (f * g),
                y = M.offset().left + T.l + c * e - s * l / 2 + c, I = M.offset().top + T.t + w * r - h * l / 2 + w,
                z = n(y, I, x, v), C = {
                    opacity: 1,
                    left: s * e / f,
                    top: h * r / g,
            ...
            var e = t % f, n = Math.floor(t / f), o = .2 * p + .15 * p * (35 * a(e, f) + 4 * n) / (f * g);
            d(this).css({
                left: s / 2,
                top: h / 2,
                width: 0,
        ...
        }), I.delay(.1 * p).animate({opacity: 1}, .2 * p, "easeInCirc")), setTimeout(r, o ? .5 * p : .4 * p), {
            stop: function () {
                r()
            }
        }
    ...
    function r(t, e, i, a) {
        ...
        for (var r = d("<div></div>").css({
            ...
            var f = Math.PI * h * l, g = c * l + 1, p = g * Math.cos(f), w = g * Math.sin(f);
    ...
    function s(t, e, i, a, n, o) {
        if (!(isNaN(o) || 1 > o)) {
            ...
            var d, c, l, f, g, p, w, u, m, v, x, b, y, M, I, T, z, L, Q, _, O = r.data, j = o + o + 1, D = a - 1,
                k = n - 1, q = o + 1, A = q * (q + 1) / 2, B = new h, F = B;
            for (l = 1; j > l; l++) if (F = F.next = new h, l == q) var N = F;
            F.next = B;
            var P = null, G = null;
            w = p = 0;
            var H = C[o], J = E[o];
    ...
    var d = jQuery, c = d(this), l = t.distance || 5, f = t.cols, g = t.rows, p = 2 * t.duration, w = t.blur || 50,
        u = (i.find(".ws_list"), []), m = [], v = d("<div>").css({
            position: "absolute",
            top: 0,
            left: 0,
            width: "100%",
    ...
    var b, y = !t.noCanvas && !window.opera && !!document.createElement("canvas").getContext,
        M = d("<div>").addClass("ws_parts"), I = d("<div>").addClass("ws_zoom");
    v.append(M, I, x).appendTo(i);
    var T = {t: d(window).scrollTop(), l: d(window).scrollLeft(), w: d(window).width(), h: d(window).height()};
    jQuery.extend(jQuery.easing, {
    ...
    this.go = function (a, n) {
        ...
        } else I.append(d("<img>").css({position: "absolute", top: 0, left: 0}).css(l).attr("src", e.get(n).src));
...
function ws_cube(t, e, i) {
    ...
    var n = jQuery, o = n(this), r = /iPhone|iPod|iPad|Android|BlackBerry/.test(navigator.userAgent),
        a = n(".ws_list", i), d = t.perspective || 2e3, h = {
            position: "absolute",
    ...
    var p = {
        domPrefixes: " Webkit Moz ms O Khtml".split(" "), testDom: function (t) {
            for (var e = this.domPrefixes.length; e--;) if ("undefined" != typeof document.body.style[this.domPrefixes[e] + t]) return !0;
            return !1
            ...
            if (t && /AppleWebKit/.test(navigator.userAgent)) {
                var e = document.createElement("div"), i = document.createElement("style"),
    ...
    }, f = p.cssTransitions() && p.cssTransforms3d(), g = p.webkit();
    if (!f && t.fallback) return new t.fallback(t, e, i);
    var u;
    this.go = function (p, l) {
        function m(e, i, o, a, c, p, f, u, l, m) {
            e.parent().css("perspective", d);
            var v = e.width(), w = e.height();
            if (i.front.css({transform: "rotateY(0deg) rotateX(0deg)"}), i.back.css({
                    opacity: 1,
            ...
            g && e.css({transform: "translateZ(-" + o + "px)"});
            var T = setTimeout(function () {
                ...
                i.front.css({
                    ...
                    zIndex: 20
                }), r || (b.css({transition: e, boxShadow: s(v, w, u, l)}), x.css({
                    transition: e,
                    boxShadow: s(v, w, 0, 0)
        ...
        if (v = {
            ...
            u && u.stop();
            var w = i.width(), b = i.height(), x = {
                    left: [w / 2, w / 2, 0, 0, 90, 0, -90],
                    right: [w / 2, -w / 2, 0, 0, -90, 0, 90],
                    down: [b / 2, 0, -b / 2, 90, 0, -90, 0],
                    up: [b / 2, 0, b / 2, -90, 0, 90, 0]
                }[t.direction || ["left", "right", "down", "up"][Math.floor(4 * Math.random())]], T = n("<img>").css(v),
                y = n("<img>").css(v).attr("src", e.get(p).src), k = n("<div>").css({
                    overflow: "hidden",
                    transformOrigin: "50% 50% -" + x[0] + "px",
                    zIndex: 20
                }).css(h).append(T).appendTo(c), z = n("<div>").css({
                    overflow: "hidden",
                    transformOrigin: "50% 50% -" + x[0] + "px",
                    zIndex: 0
            ...
            c.css({position: "absolute", display: "none", zIndex: 2, width: "100%", height: "100%"}), c.stop(1, 1);
            var C = !!((p - l + 1) % e.length) ^ t.revers ? "left" : "right", k = n("<div>").css({
                position: "absolute",
                left: "0%",
                right: "auto",
                top: 0,
            ...
            c.css({left: "auto", right: "auto", top: 0}).css(C, 0).show(), c.show(), a.hide(), I.animate({
                width: "100%",
                left: 0
            }, t.duration, "easeInOutExpo", function () {
                n(this).remove()
            }), k.animate({width: 0}, t.duration, "easeInOutExpo", function () {
...
function ws_brick(t, e, a) {
    function r(a) {
        for (var r = {}, n = e.get(a), o = t.width / f, i = t.height / h, d = 0; f * h > d; d++) {
            var a = d % f, l = Math.floor(d / f);
            r[d] = s(n, {x: a * o, y: l * i, w: o, h: i})
        }
        return r
    }
    ...
    function o(t, e) {
        var a, r, n, o, i, s = (new Date).getTime(), l = function () {
            ...
            for (var h in t) if (!(s + t[h].animate.delay > f)) {
                ...
                if (i = {}, o = "", c > 1) {
                    ...
                    t[h].wrapper.css({transform: "translate3d(" + (i.left ? i.left : 0).toFixed(3) + "px," + (i.top ? i.top : 0).toFixed(3) + "px,0)"}), delete i.left, delete i.top, o && (i.transform = o), t[h].part.css(i)
                }
            }
    ...
    function i(e, r, i, s) {
        var d = a.width(), l = a.height(), c = d / f, p = l / h, g = .4 * t.duration > 1e3 ? 1e3 : .4 * t.duration,
            m = .6 * t.duration, u = [0, 0];
        n(w, e, v[r], c, p), x.css({transformOrigin: d / 2 + "px " + l / 2 + "px 0", width: d, height: l});
        for (var b in e) {
            var k = T[b].delay * g;
        ...
        for (var b in e) {
            ...
            F.animate = {
                ...
                end: {left: 0, top: 0, scale: 1, rotateX: T[b].rotateX, rotateY: T[b].rotateY, translate3d: [0, 0, w]}
    ...
    var d = jQuery, l = d(this), f = t.cols || 4, h = t.rows || 3, c = 2.5, p = 2, g = t.perspective || 2e3,
        m = a.find(".ws_list"), u = [], w = 30, v = {},
    ...
    var T = [{
        ...
        halfTop: -.4,
        delay: .57
    }, {zIndex: 0, rotateX: 360, rotateZ: -360, rotateY: -180, halfScale: .5, halfLeft: -.7, halfTop: -.7, delay: .9}];
    x.css({
        position: "absolute",
        top: 0,
        left: 0,
        ...
        window.requestAnimationFrame || (window.requestAnimationFrame = function (e) {
            var a = (new Date).getTime(), r = Math.max(0, 16 - (a - t)), n = window.setTimeout(function () {
                e(a + r)
            }, r);
            return t = a + r, n
    ...
    this.go = function (n, o) {
        ...
        if (F) return o;
        for (var g = 0; f * h > g; g++) {
            var Y = g % f, X = Math.floor(g / f), I = d("<div>").css({
                    position: "absolute",
                    left: 100 * Y / f + "%",
                    top: 100 * X / h + "%",
                ...
                }).appendTo(x), _ = d("<div>").css({
                    transform: "scale(1) rotateX(0) rotateY(0) translate3d(0,0,0)",
                    outline: "1px solid transparent",
                    transformStyle: "preserve-3d"
                }).appendTo(I), S = d("<div>").addClass("ws_front_image").appendTo(_),
            ...
            var A = {position: "absolute", outline: "1px solid transparent"};
            u[g] = {
                part: _,
                front: S,
                back: z,
        ...
        if (L = {
            ...
            v[o] || (v[o] = r(o)), F = new i(u, o, L, function () {
                ...
                for (var t in u) u[t].part.css({transition: "", transform: "rotateX(0) rotateY(0) translate3d(0,0,0)"});
                F = 0
            })
        } else {
            F = !0;
            var B = a.width(), C = a.height(), E = B / f, Q = C / h;
            x.css({width: B, height: C});
            var O = 0;
            for (var Z in u) {
                var Y = Z % f, X = Math.floor(Z / f);
                u[Z].front.find("img").attr("src", e.get(n).src).css(L);
                var j = t.duration * (1 - Math.abs((p * c - Y * X) / (2 * h * f))), q = s(-1, 1) > 0 ? 1 : -1,
                    M = s(-1, 1) > 0 ? 1 : -1;
                u[Z].wrapper.css({width: E, height: Q}), u[Z].part.css({
                    position: "absolute",
                    top: q * Q,
                    left: M * E,
                    opacity: 0,
                    width: E,
                    height: Q
                }).animate({top: 0, left: 0, opacity: 1}, j, function () {
...
function ws_blinds(t, i, e) {
    ...
    this.go = function (l, h, p) {
        var g = h > l ? 1 : 0;
        if (p) if (-1 >= p) l = (h + 1) % i.length, g = 0; else {
            if (!(p >= 1)) return -1;
        ...
        var w = o(i[h]), c = {width: w.width() || t.width, height: w.height() || t.height},
            v = w.clone().css(c).appendTo(a);
        n(v, {left: 0}), n(v, {left: (g ? -1 : 1) * v.width() * .5}, t.duration, .1 * t.duration);
        for (var m = 0; m < f.length; m++) {
            var T = f[m], b = o(i[l]).clone().css({position: "absolute", top: 0}).css(c).appendTo(T);
            n(b, {left: g ? b.width() - T.position().left : -b.width()}), n(b, {left: -T.position().left}, t.duration / (f.length + 1) * (g ? f.length - m + 1 : m + 2), 0, !g && m == f.length - 1 || g && !m ? function () {
...
(function () {
    ...
    a.version = "1.5.2";
    var b = /[, ]+/, c = {circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1}, d = /\{(\d+)\}/g,
        e = "prototype", f = "hasOwnProperty", g = document, h = window,
        i = {was: Object[e][f].call(h, "Raphael"), is: h.Raphael}, j = function () {
            this.customAttributes = {}
        }, k, l = "appendChild", m = "apply", n = "concat", o = "createTouch" in g, p = "", q = " ", r = String,
        s = "split",
        ...
        u = {mousedown: "touchstart", mousemove: "touchmove", mouseup: "touchend"}, v = "join", w = "length",
        x = r[e].toLowerCase, y = Math, z = y.max, A = y.min, B = y.abs, C = y.pow, D = y.PI, E = "number",
        F = "string", G = "array", H = "toString", I = "fill", J = Object[e][H], K = {}, L = "push",
        M = /^url\(['"]?([^\)]+?)['"]?\)$/i,
        ...
        O = {"NaN": 1, Infinity: 1, "-Infinity": 1}, P = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/,
        Q = y.round, R = "setAttribute", S = parseFloat, T = parseInt, U = " progid:DXImageTransform.Microsoft",
        V = r[e].toUpperCase, W = {
            blur: 0,
            ...
            x: E,
            y: E
        }, Y = "replace", Z = /^(from|to|\d+%?)$/, $ = /\s*,\s*/, _ = {hs: 1, rg: 1}, ba = /,?([achlmqrstvxz]),?/gi,
        bb = /([achlmqstvz])[\s,]*((-?\d*\.?\d*(?:e[-+]?\d+)?\s*,?\s*)+)/ig,
        bc = /(-?\d*\.?\d*(?:e[-+]?\d+)?)\s*,?\s*/ig, bd = /^r(?:\(([^,]+?)\s*,\s*([^\)]+?)\))?/, be = function (a, b) {
            return a.key - b.key
        };
    ...
    a.findDotsAtSegment = function (a, b, c, d, e, f, g, h, i) {
        var j = 1 - i, k = C(j, 3) * a + C(j, 2) * 3 * i * c + j * 3 * i * i * e + C(i, 3) * g,
            l = C(j, 3) * b + C(j, 2) * 3 * i * d + j * 3 * i * i * f + C(i, 3) * h,
            m = a + 2 * i * (c - a) + i * i * (e - 2 * c + a), n = b + 2 * i * (d - b) + i * i * (f - 2 * d + b),
            o = c + 2 * i * (e - c) + i * i * (g - 2 * e + c), p = d + 2 * i * (f - d) + i * i * (h - 2 * f + d),
            q = (1 - i) * a + i * c, r = (1 - i) * b + i * d, s = (1 - i) * e + i * g, t = (1 - i) * f + i * h,
    ...
    var bn = bm(function (a) {
        ...
        if (j) {
            ...
            h = o.x;
            i = o.y;
            var q = y.cos(D / 180 * e), r = y.sin(D / 180 * e), t = (a - h) / 2, u = (b - i) / 2,
                x = t * t / (c * c) + u * u / (d * d);
            if (x > 1) {
                x = y.sqrt(x);
                c = x * c;
            ...
            var z = c * c, A = d * d,
                ...
                E = C * c * u / d + (a + h) / 2, F = C * -d * t / c + (b + i) / 2, G = y.asin(((b - F) / d).toFixed(9)),
        ...
        I = H - G;
        var M = y.cos(G), N = y.sin(G), O = y.cos(H), P = y.sin(H), Q = y.tan(I / 4), R = 4 / 3 * c * Q,
            S = 4 / 3 * d * Q, T = [a, b], U = [a + R * N, b - S * M], V = [h + R * P, i - S * O], W = [h, i];
        U[0] = 2 * T[0] - U[0];
        U[1] = 2 * T[1] - U[1];
        {
        ...
        var i = e - 2 * c + a - (g - 2 * e + c), j = 2 * (c - a) - 2 * (e - c), k = a - c,
            l = (-j + y.sqrt(j * j - 4 * i * k)) / 2 / i, n = (-j - y.sqrt(j * j - 4 * i * k)) / 2 / i, o = [b, h],
            p = [a, g], q;
        B(l) > "1e12" && (l = 0.5);
        B(n) > "1e12" && (n = 0.5);
        if (l > 0 && l < 1) {
        ...
        var c = bq(a), d = b && bq(b), e = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null},
    ...
    if (a.vml) {
        var bW = {M: "m", L: "l", C: "c", Z: "x", m: "t", l: "r", c: "v", z: "x"}, bX = /([clmz]),?([^clmz]*)/gi,
            bY = / progid:\S+Blur\([^\)]+\)/g, bZ = /-?[^,\s-]+/g, b$ = 1000 + q + 1000, b_ = 10,
            ca = {path: 1, rect: 1}, cb = function (a) {
        ...
        bK = function (c, d) {
            ...
            var e = c.node, h = c.attrs, i = e.style, j,
                k = (d.x != h.x || d.y != h.y || d.width != h.width || d.height != h.height || d.r != h.r) && c.type == "rect",
                m = c;
    ...
    var cf = function () {
        ...
        var b = a.clientX, c = a.clientY, d = g.documentElement.scrollTop || g.body.scrollTop,
            e = g.documentElement.scrollLeft || g.body.scrollLeft, f, h = ck.length;
        while (h--) {
            f = ck[h];
            if (o) {
    ...
    bO.scale = function (a, b, c, d) {
        ...
        if (a != 0) {
            var j = this.getBBox(), k = j.x + j.width / 2, l = j.y + j.height / 2, m = B(a / this._.sx),
                o = B(b / this._.sy);
            c = +c || c == 0 ? c : k;
            d = +d || d == 0 ? d : l;
            var r = this._.sx > 0, s = this._.sy > 0, t = ~(~(a / B(a))), u = ~(~(b / B(b))), x = m * t, y = o * u,
                z = this.node.style, A = c + B(k - c) * x * (k > c == r ? 1 : -1),
                C = d + B(l - d) * y * (l > d == s ? 1 : -1), D = a * t > b * u ? o : m;
            switch (this.type) {
                case"rect":
                case"image":
    ...
    k.print = function (c, d, e, f, g, h, i) {
        ...
        if (f) {
            ...
            var o = f.face.bbox.split(b), q = +o[0],
...
var o = {
    init: function () {
        ...
        var title = r.text(300, 300, defaultText).attr({font: '20px Arial', fill: '#fff'}).toFront();
        r.customAttributes.arc = function (value, color, rad) {
            var v = 3.6 * value, alpha = v == 360 ? 359.99 : v, random = o.random(91, 240),
                a = (random - alpha) * Math.PI / 180, b = random * Math.PI / 180, sx = 300 + rad * Math.cos(b),
                sy = 300 - rad * Math.sin(b), x = 300 + rad * Math.cos(a), y = 300 - rad * Math.sin(a),
...
;$(function () {
    (function () {
        ...
        var mouse = {X: 0, Y: 0, CX: 0, CY: 0}, block = {X: mouse.X, Y: mouse.Y, CX: mouse.CX, CY: mouse.CY},
        ...
        $('.W-introduce-me').on('click', function () {
            window.open('https://lvdeyouli.github.io')
        });
        ...
        var sound = new Howl({src: ["./source/audio/show.mp3"], autoplay: true, loop: true});
        ...
        if (!!window.ActiveXObject || "ActiveXObject" in window) {
            ...
            $('.W-introduce-me').css({
                'background': 'url(../source/images/-Anti-stealing-link=img&path=me1.jpg) no-repeat',
        ...
        if ($(window).width() <= 770) {
            ...
            $('.navigation').find('li').eq(6).on('click touchstart', function () {
                window.location.href = "https://lvdeyouli.github.io"
            })
        }
        ...
        $(window).scroll(function () {
            var topH = $(window).scrollTop(), topc = top1 - topH, topji = top2 - topH, topzuo = top3 - topH,
                toplian = top4 - topH;
